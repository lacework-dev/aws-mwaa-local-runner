...
with DAG(
    ...
    snowflake_operator_test_prod_eu = SnowflakeOperator(
        task_id="snowflake_operator_test_prod_eu",
        sql="SELECT 1",
    ...
    snowflake_operator_test_prod_au = SnowflakeOperator(
        task_id="snowflake_operator_test_prod_au",
        sql="SELECT 1",
    ...
    snowflake_operator_test_spork2 = SnowflakeOperator(
        task_id="snowflake_operator_test_spork2",
        sql="SELECT 1",
        snowflake_conn_id="snowflake_spork",
        role="public",

    )

    snowflake_operator_test_lwdev = SnowflakeOperator(
        task_id="snowflake_operator_test_lwdev",
        sql="SELECT 1",
        snowflake_conn_id="snowflake_lwdev",
        role="public",
...
chain(
    ...
    snowflake_operator_test_prod_eu,
    snowflake_operator_test_spork2,
    snowflake_operator_test_lwdev,
    snowflake_operator_test_prod_au,
    end,
)
